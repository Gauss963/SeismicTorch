...
int main(int argc, char **argv) {
 ...
 Mxx[3] (the Up, Radial, and Transverse displacements produced by Mxx),\n\
 2*Mxy[3], 2*Mxz[3], Myy[3], 2*Myz[3], and Mzz[3].\n\
 Note that x=North, y=East, z=Down, and T is to the right of R.\n",argv[0]);
    return -1;
  }
